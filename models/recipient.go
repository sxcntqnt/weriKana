// models/recipient.go
// Recipient model — Updated for Sharp merge: FK to SharpID (replaces CustomerID); UUID gen in BeforeCreate.
// Matches Sender structure for payout recipients (person/business verification).
...
type Recipient struct {
	...
	SharpID              uuid.UUID  `gorm:"type:uuid;index;not null"` // Links to Sharp (replaces CustomerID)
